...
class Order3Screen1 extends StatelessWidget {
  const Order3Screen1({super.key});
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _infoText('Delivery Date: 2025-04-25'),
                  ...
                  Table(
                    ...
                    children: [
                      _buildTableHeader(),
                      _buildTableRow('Asparagus', '80'),
                      _buildTableRow('Turnip', '45'),
                      _buildTableRow('Pumpkin', '56'),
                      _buildTableRow('Celery', '90'),
                      _buildTableRow('Green beans', '45'),
                    ],
                  ),
                ],
              ),
